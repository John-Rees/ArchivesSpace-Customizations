# add endpoints you want accessible via Javascript
...
class CORSMiddleware
  ...
  def call(env)
    ...
    # Add CORS headers to particular endpoints...
    if env['REQUEST_METHOD'] == 'GET' &&
       result[0] == 200 &&
       @patterns.any? {|pattern| env['REQUEST_PATH'] =~ pattern}
...
# Add our new Rack middleware to ArchivesSpace
