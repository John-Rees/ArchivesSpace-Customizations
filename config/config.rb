...
AppConfig[:authentication_sources] = [{
                                         :model => 'LDAPAuth',
                                         :hostname => 'racdc2k8.ad.rockarchive.org',
                                         :port => 389,
                                         :base_dn => 'OU=Main Building,OU=RAC,DC=ad,DC=rockarchive,DC=org',
                                         :username_attribute => 'sAMaccountName',
                                         :attribute_map => {:cn => :name},
                                         :bind_dn => 'CN=archivesspace,OU=ACCESS,OU=ACCOUNTS,OU=RAC,DC=ad,DC=rockarchive,DC=org',
